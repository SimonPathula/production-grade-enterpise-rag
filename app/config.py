...
class Settings:
    # --- GCP Core ---
    PROJECT_ID = os.getenv("PROJECT_ID", "able-analyst-501113-c5")
    LOCATION = os.getenv("LOCATION", "us-central1")
    GCP_DOC_AI_LOCATION = os.getenv("GCP_DOC_AI_LOCATION", "us")
    GCP_DOC_AI_PROCESSOR_ID = os.getenv("GCP_DOC_AI_PROCESSOR_ID", "4ab16c30abde9d5c")
    RAW_BUCKET = os.getenv("GCP_RAW_BUCKET", "simonpathula-enterpriserag-raw")
    PROCESSED_BUCKET = os.getenv("GCP_PROCESSED_BUCKET", "simonpathula-enterpriserag-processed")

    # --- Vector DB (Qdrant) ---
    QDRANT_URL = os.getenv("QDRANT_CLUSTER_ENDPOINT")
    QDRANT_API_KEY = os.getenv("QDRANT_API_KEY")
    # QDRANT_COLLECTION = "enterpriserag"
    QDRANT_COLLECTION = "enterpriserag-hf"
...
os.environ["LANGCHAIN_PROJECT"] = os.getenv("LANGSMITH_PROJECT", "entrepriserag")
